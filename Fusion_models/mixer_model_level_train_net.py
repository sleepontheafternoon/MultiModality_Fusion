...
import os
import time
from utils.mixer_fusion import Mixer_fusion
...
def select_model(model_num=0):
    ...
    # 分别代表mixer model level
    if model_num == 0:
        model1 = generate_Res_model(34,n_input_channels=1,n_classes=args.classes)
        model = Mixer_fusion(model1)
        args.model_name = "Resnet_Mixer"
    else:
        model = generate_Res_add_model(34,n_input_channels=1,n_classes=args.classes)
        args.model_name = "Resnet_model_level"
